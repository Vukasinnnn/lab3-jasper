#Note that include is a Jasper Tcl command not a native Tcl command.
#It behaves exactly like source but echos to the logs the command outputs
include ./example_proofgrid_setup.tcl
################
# Clear
################
clear -all
